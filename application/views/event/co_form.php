...
<div class="col-lg-8 mx-auto">
    <!--Include menu-->
     <h1 class="h1" style="margin:10px;">Edit Roadshow</h1>
<form method="post" action="<?php echo base_url('index.php/show/edit_act') ?>">
   
    <input type="hidden" name="id_show" value="<?php echo $product->id_show;?>" />
    <div class="form-group">
    <label for="exampleInputEmail1">Nama Roadshow  </label>
        <input type="text" label="nama" class="form-control" name="nama" placeholder="nama" value="<?php echo $product->nama ?>" required>
  </div>  
  <div class="form-group">
    <label for="exampleInputEmail1">Lokasi  </label>
    <input type="text" label="lokasi" class="form-control"  value="<?php echo $product->lokasi ?>" name="lokasi" placeholder="lokasi" required>
  </div> 
    <div class="form-group">
    <label for="exampleInputEmail1">Kota  </label>
    <input type="text" label="lokasi" class="form-control"  value="<?php echo $product->kota ?>" name="kota" placeholder="kota" required>
  </div> 
  <div class="form-group">
    <label for="exampleInputEmail1">Tanggal </label>
      
    <input type="date" class="form-control"  label="tanggal" value="<?php echo $product->tanggal ?>" placeholder="Tanggal" name="tanggal" required>
  </div>
 <div class="form-group">
    <label for="exampleInputEmail1">Keseluruhan Tiket  </label>
   <input type="number" class="form-control" label="keseluruhan_tiket" value="<?php echo $product->keseluruhan_tiket ?>" name="keseluruhan_tiket" placeholder="keseluruhan tiket" required>
  </div>
    ...
    <input type="checkbox" name="edit" value="Ya">
