...
<body class="horizontal-fixed">
    ...
    <div class="container">
      <div class="col">
        ...
        <div class="row">   
      <form class="form-inline" method="post" action="<?=base_url('index.php/pemesanan/cari_pemesanan') ?>">
        <input type="text" name="kode_unik">
        <button type="submit" name="submit" class="btn btn-primary mb-2">Cari</button>
      </form>
      </div>
      </div>
